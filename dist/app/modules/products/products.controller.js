...
const createProducts = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    if (req.file) {
        req.body.productImage = yield (0, s3_1.uploadToS3)({
            file: req.file,
            fileName: `images/products/${Math.floor(100000 + Math.random() * 900000)}`,
        });
    }
    const result = yield products_service_1.productsService.createProducts(req.body);
...
const getByKeyWords = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield products_service_1.productsService.findKeywords();
    (0, sendResponse_1.default)(res, {
        statusCode: 200,
        success: true,
...
const updateProducts = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield products_service_1.productsService.updateProducts(req.params.id, req.body);
    (0, sendResponse_1.default)(res, {
        statusCode: 200,
        success: true,
